...
1. New Project<br><figure>![](images/new_gitlab_project_button.png)</figure>
1. Add a project name.  Use the name *test-one*<br><figure>![](images/project_name.png "replace 'my-awesome-project' with 'test-one'") <figcaption>replace 'my-awesome-project' with 'test-one'</figcaption></figure>
<figure>![](images/create_project.png)<figcaption>Create Project</figcaption></figure>  
...
<br><figure>![](images/readme.png)<figcaption>Open in a new tab for each link: README, LICENSE, and .gitignore</figcaption></figure>
...
<br><figure>![](images/license.png) 
<figcaption>Appply a license format</figcaption>
</figure>
...
<br><figure>![](images/copy_repo.png)
<figcaption>Copy the repo URL</figcaption>
</figure>

1. Launch RStudio and create a *New Project...*

    1. From the RStudio menubar:  *File > New Project...* > Version Control > Git
    <br><figure>![](images/project_version_git.png)<figcaption>Paste the GitLab repo URL (from the step above) into the  *Repository URL:* field in RStudio</figcaption></figure>

    1. Create Project
    1. You may be prompted with a message which asks if you about the "authenticity of host".  I like to verify the IP number is correct; then the answer is `yes`.
    
<figure>![](images/yes.png)</figure>
...
1. In the Git pane:
    ...
    <br><figure>![](images/commit_push.png)</figure>
...
<figure>![](images/git_push_pull.png)</figure>
