...
![](images/project_name.png "replace 'my-awesome-project' with 'test-one'") 
...
![](images/readme.png)
<figcaption>Open in a new tab for each link: README, LICENSE, and .gitignore</figcaption>
...
<figcaption>Paste the GitLab repo URL (from the step above) into the  *Repository URL:* field in RStudio</figcaption>
