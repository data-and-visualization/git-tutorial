...
1. Make a license file (Open in a New Tab, click the LICENSE link) 
    ...
    1. ![](images/license.png) <br>click *Appply a license format* > choose *MIT* (or paste in a Creative Commons License) 
    1. Commit changes
...
1. Congratulations.  You've just created your first GitLab repository.  Click *test-one* in the top-left of your screen and you'll see your repository -- including the three files you just created.
...
1. Copy GitLab URL to clipboard 
    ...
    - ![](images/copy_repo.png) -- Copy the repo URL
