...
- Git orchestrator (integrates with an documented repository)
- Literate Code editor (readable by Humans)
- Data Science coding language

    - Manages Code?  Check!
    - Or it can be used just like a word processor and a Desktop Publisher
    - Project Management containter 
...
- Open Reproducible Projects = R Markdown + R Notebooks + literate code + Git
