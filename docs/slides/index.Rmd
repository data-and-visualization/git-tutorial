...
I want to emphasize that *R* and *Git* are ideal for *reproducible Data Science*.  However, the added factor of **R Markdown** -- when combined with various R packages -- makes R a flexible report generation system arguably more *open* and *reproducible* than other proprietary collaborations systems.
...
Introduce the idea of "LOCKSS" cloud version.  "Lots of Copies Keeps Stuff Safe."  Can work in various locations on various computers (e.g. at home and at work) without worrying about version or file location.
...
Notably:  **You Don't have to be a coder** to benefit from Version Control and R Markdown.  The two method/features can be used to compose all of your reporting needs, including MS Word, PDF, LaTex, WebPages, WebSites, Slides, etc.
