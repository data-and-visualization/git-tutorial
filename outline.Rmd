...
- **Git**: <a href="https://git-scm.com/downloads" target="_blank">https://git-scm.com/downloads</a>
    ...
    <br><figure>![](images/git_os.png "Click on the link to your OS")</figure>
...
- **RStudio**: <a href="https://www.rstudio.com/products/rstudio/download/#download" target="_blank">https://www.rstudio.com/products/rstudio/download/#download</a><br><figure>![](images/rstudio_download.png)</figure>
...
<figure>![](images/gitlab_shib_login.png)<figcaption>Be certain you log-in via "Duke Shibboleth Login" using your NetID</figcaption></figure>
...
1. To begin, open a shell **from RStudio**
    ...
    - In RStudio > Menubar > `Tools > Shell...`<br><figure>![](images/shell.png)</figure>
